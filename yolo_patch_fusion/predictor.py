...
class PatchDetectionPredictor(yolo.detect.DetectionPredictor):
    ...
    def __call__(self, source=None, model=None, stream=False, overlap: int = 50, *args, **kwargs):
    ...
    def infer_on_crop(self, crop: np.ndarray, model=None, stream=False, *args, **kwargs):
        results = super().__call__(crop, model, stream, *args, **kwargs)
